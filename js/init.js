...
jQuery(document).ready(function(){
	...
	// Dark mode toggle using the slider checkbox
...
function grax_tm_switcher_opener(){
	...
	if(localStorage.getItem('theme') === 'dark'){
		jQuery('body').addClass('dark');
		settings.find('.direction li a.dark').addClass('active');
		settings.find('.direction li a.light').removeClass('active');
		settings.addClass('changed');
	}else{
		jQuery('body').removeClass('dark');
		settings.find('.direction li a.light').addClass('active');
		settings.find('.direction li a.dark').removeClass('active');
